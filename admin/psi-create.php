...
<div class="wrap psi">
    ...
    <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
        ...
        <tr>
            ...
            <td>Maandag</td><td><input type="text" name="moo" placeholder="12:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="moc" placeholder="18:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        <tr>
            <td>Adres:</td><td><input type="text" name="address" placeholder="Adres" required pattern="[A-Za-z-0-9\s]+"/></td>
            <td>Dinsdag</td><td><input type="text" name="tuo" placeholder="12:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="tuc" placeholder="18:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        <tr>
            ...
            <td>Woensdag</td><td><input type="text" name="weo" placeholder="12:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="wec" placeholder="18:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        <tr>
            <td>Telefoon:</td><td><input type="text" name="telephone" placeholder="0680000000" required /></td>
            <td>Donderdag</td><td><input type="text" name="tho" placeholder="12:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="thc" placeholder="18:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        <tr>
            <td>Mail:</td><td><input type="email" name="email" placeholder="john@test.nl" required /></td>
            <td>Vrijdag</td><td><input type="text" name="fro" placeholder="12:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="frc" placeholder="18:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        <tr>
            ...
            <td>Zaterdag</td><td><input type="text" name="sao" placeholder="12:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="sac" placeholder="18:00" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        <tr>
            <td>Beschrijving:</td><td><textarea name="text" placeholder="Wat is ut"></textarea></td>
            <td>Zondag</td><td><input type="text" name="suo" placeholder="gesloten" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
            <td><input type="text" name="suc" placeholder="gesloten" required pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}|gesloten"/></td>
        </tr>
        </table>
